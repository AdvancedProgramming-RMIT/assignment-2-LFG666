...
public class Perscription extends Medicines {
	...
	private DoubleProperty dosage = new SimpleDoubleProperty();
	...
	public Perscription(int ids, String MName, int stocK, String fName, String lName, String dName, double dosage, int times) {
	...
	public DoubleProperty dosageProperty() {
		return this.dosage;
	}
